...
forprim <- "TTGGAGGGCAAGTCTGGTGCC" # forward primer
revprim <- "GAACCCAAACACTTTGGTTTCC" # reverse primer
...
# filtering (reads.out).
# (5) Trim primers using the trimLeft argument. For 16S we used 
# 341F (CCTACGGGNGGCWGCAG) and 785R (GACTACHVGGGTATCTAATCC)
