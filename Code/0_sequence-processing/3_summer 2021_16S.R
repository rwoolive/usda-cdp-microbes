...
list.files(path)
write.csv(list.files(path), paste0("Raw-data/sequence/",sampdate,"_agmicrobiome/", name, "_file-names.csv"))

# listing file names for raw files
# path <- "Raw-data/sequence/2023 summer-2024 fall_agmicriobiome/16S/rocky_data_16S/raw/raw/"
# write.csv(list.files(path),
#           "Raw-data/sequence/2023 summer-2024 fall_agmicriobiome/16S_file-names.csv")
# write.csv(list.files("Raw-data/sequence/2022-fall 2023-spring summer_agmicrobiome/Fungi/rocky_dada_ITS/raw/raw/"),
#           "Raw-data/sequence/2022-fall 2023-spring summer_agmicrobiome/Fungi_file-names.csv")

# setting up ncbi sra
# path <- "Raw-data/sequence/All_agmicrobiome/SRA raw sequences/"
# seq.files <- (list.files(path))
# seq.tab <- read_excel("Raw-data/sequence/All_agmicrobiome/metadata.xlsx")
# 2*dim(seq.tab)[1]
# '%notin%' <- Negate('%in%')
# seqsmissing <- seq.tab[which(seq.tab$`utg.name forward` %notin% seq.files),]
# seqsmissing2 <- seq.tab[which(seq.tab$`utg.name reverse` %notin% seq.files),]
# seqsmissing <- seq.tab$`utg.name forward`[which(seq.tab$`utg.name forward` %notin% seq.files)]
# seqsmissing2 <- seq.tab$`utg.name reverse`[which(seq.tab$`utg.name reverse` %notin% seq.files)]
# file.copy(file.path("Raw-data/sequence/2022-spring_agmicrobiome/Fungi/raw", 
#                     c(seqsmissing, seqsmissing2)), #
#           "Raw-data/sequence/All_agmicrobiome/SRA raw sequences/")
# 
# seqover <- seq.files[which(seq.files %notin% c(seq.tab$`utg.name forward`, seq.tab$`utg.name reverse`))]
# 
# file.remove(file.path("Raw-data/sequence/All_agmicrobiome/SRA raw sequences", 
#                       seqover))

# # moving files to new folders based on SRA
# library(readxl)
# library(dplyr)
# mydat <- read_excel("Raw-data/sequence/All_agmicrobiome/metadata.xlsx")
# # SRA 1
# sra1 <- mydat %>% 
#   filter(SRA == 1)
# # forward reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra1$Filename), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 1/", sra1$Filename))
# # reverse reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra1$`Filename 2`), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 1/", sra1$`Filename 2`))
# # SRA 2
# sra2 <- mydat %>% 
#   filter(SRA == 2)
# # forward reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra2$Filename), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 2/", sra2$Filename))
# # reverse reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra2$`Filename 2`), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 2/", sra2$`Filename 2`))
# 
# # SRA 3
# '%notin%' <- Negate("%in%")
# fs <- list.files("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/")
# tomove <- c(sra3$Filename, sra3$`Filename 2`)[which(c(sra3$Filename, sra3$`Filename 2`) %notin% fs)] 
# 
# tomove %in% list.files(paste0("Raw-data/sequence/2022-spring_agmicrobiome/Fungi/raw/"))
# file.copy(paste0("Raw-data/sequence/2022-spring_agmicrobiome/Fungi/raw/", tomove), "Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", overwrite = F)
# 
# sra3 <- mydat %>% 
#   filter(SRA == 3)
# # forward reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra3$Filename), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 3/", sra3$Filename))
# # reverse reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra3$`Filename 2`), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 3/", sra3$`Filename 2`))
# 
# # SRA 4
# sra4 <- mydat %>% 
#   filter(SRA == 4)
# # forward reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra4$Filename), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 4/", sra4$Filename))
# # reverse reads
# fs::file_move(paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences/", sra4$`Filename 2`), 
#               paste0("Raw-data/sequence/All_agmicrobiome/SRA raw sequences 4/", sra4$`Filename 2`))
...
sample.names0 <- sapply(strsplit(basename(fnFs), "-"), `[`, 1)

# The following were re-extracted and resequenced
# 110-1_Summer_2021
# 118-1_Summer_2021
# 202-1_Summer_2021
# 215-1_Summer_2021
...
sample.names0[81:86] <- c("110r", "118r", "202r","215r", "216r", "318r")

sample.names <- paste0(sample.names0,"_","16S", "_",sampdate)
...
pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_1-20.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(1:20)]) # forward reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_21-40.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(21:40)]) # forward reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_41-60.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(41:60)]) # forward reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_61-80.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(61:80)]) # forward reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_81-87.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(81:87)]) # forward reads
dev.off()
...
pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_1-20.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(1:20)]) # reverse reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_21-40.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(21:40)]) # reverse reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_41-60.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(41:60)]) # reverse reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_61-80.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(61:80)]) # reverse reads
dev.off()

pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_81-87.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(81:87)]) # reverse reads
dev.off()
