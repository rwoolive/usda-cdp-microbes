...
sample.names <- paste0(sample.names0,"_",region, "_",sampdate)
...
pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/F_81-86.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnFs[c(81:86)]) # forward reads
dev.off()
...
pdf(paste0("Figures/sequences/",sampdate,"/qscores_",region,"/R_81-86.pdf"), height=8, width=8)
dada2::plotQualityProfile(fnRs[c(81:86)]) # forward reads
dev.off()
...
# 216-1_Summer_2021
# 318-1_Summer_2021
# rem <- which(sample.names %in% c("110_ITS_2021-07","118_ITS_2021-07","202_ITS_2021-07",
#                                  "215_ITS_2021-07","216_ITS_2021-07","318_ITS_2021-07"))

out <- dada2::filterAndTrim(fnFs[-rem], filtFs[-rem], fnRs[-rem], filtRs[-rem], truncLen=tlens, 
