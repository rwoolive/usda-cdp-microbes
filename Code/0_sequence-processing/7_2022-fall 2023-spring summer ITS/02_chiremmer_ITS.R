...
seqtables <- "rocky_dada_ITS/output/01_errors-output/rocky_dada_ITS/rocky_dada_ITS_seqtab.rds" #change to match your file structure
output <- "rocky_dada_ITS/output" # where we will dump the results//diagnostic
name <- "rocky_dada_ITS" # Run name. A directory for the values will be created
