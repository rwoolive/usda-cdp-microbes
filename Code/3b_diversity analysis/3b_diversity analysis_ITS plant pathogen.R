...
# export merged data 
write.csv(soildat, paste0("Processed-data/sequences/soil_", region,"_", subset_name, "-diversity.csv"))


ggplot(soildat, aes(x=plantpath_richness)) + geom_histogram() +
...
responses <- c("plantpath_richness", "plantpath_shannon.div", "plantpath_simpson.div", "plantpath_invsimpson.div", "plantpath_evenness")
...
write.csv(resp, paste0("Model-output/anova_", subset_name, "/all-anova.csv"))
