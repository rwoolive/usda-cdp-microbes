...
plot(s$sites, type="n", xlim=c(-2,1.5), xlab=bquote(NMDS1~"("*.(round(c1*100,0))*"%)"), ylab=bquote(NMDS2~"("*.(round(c2*100,0))*"%)"), las=1) #  , ylim=c(-1.1,1.5)
...
plot(s$sites, type="n", xlim=c(-2,1.5), xlab=bquote(NMDS1~"("*.(round(c1*100,0))*"%)"), ylab=bquote(NMDS2~"("*.(round(c2*100,0))*"%)"), las=1)
