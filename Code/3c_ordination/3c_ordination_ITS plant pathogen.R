...
taxabund <- read.csv(paste0("Raw-data/sequence/",sampdate,"/",name,"/seqtab/6seqtab","_", subset_name, ".csv"))
# import data for diversity
divdat <- read.csv(paste0("Processed-data/sequences/",region,"_", subset_name,"-diversity.csv"))
# import data for diversity
divmat_pa <- read.csv(paste0("Raw-data/sequence/",sampdate,"/divmat_pa_", region,"_", subset_name,".csv"), row.names = 1)
...
# View(s[["sites"]])
distance<-vegdist(divmat_pa, method="bray") 
...
# by year
png(paste0("Figures/microbial-diversity/nmds/all-data/",region,"_", subset_name,"_yr.png"), width=800, height=850, res = 150)
...
# by season/year
png(paste0("Figures/microbial-diversity/nmds/all-data/",region,"_", subset_name,"_ssnyr.png"), width=1000, height=1000, res = 150)
plot(s$sites, type="n", xlim=c(-3,2.8), xlab=bquote(NMDS1~"("*.(round(c1*100,0))*"%)"), ylab=bquote(NMDS2~"("*.(round(c2*100,0))*"%)"), las=1) #  , ylim=c(-1.1,1.5)
...
# by cover
png(paste0("Figures/microbial-diversity/nmds/all-data/",region,"_", subset_name,"_cover.png"), width=600, height=650, res = 150)
...
# by cropping system
png(paste0("Figures/microbial-diversity/nmds/all-data/",region,"_", subset_name,"_cropsys.png"), width=700, height=750, res = 150)
plot(s$sites, type="n", xlim=c(-3,2.8),xlab=bquote(NMDS1~"("*.(round(c1*100,0))*"%)"), ylab=bquote(NMDS2~"("*.(round(c2*100,0))*"%)"), las=1)
...
scl <-2
# by cover
png(paste0("Figures/microbial-diversity/nmds/by-season/",region,"_", subset_name, "_", ssn, "_cover.png"),  width=700, height=750, res = 150)
...
dev.off()
# by cropping system
png(paste0("Figures/microbial-diversity/nmds/by-season/",region,"_", subset_name,"_", ssn, "_cropsys.png"), width=700, height=750, res = 150)
...
write.csv(permmod2, paste0("Model-output/permanova/",name, "_", subset_name,"_permanova.csv"))
...
write.csv(mod.effects, paste0("Model-output/permanova/",name,"_", subset_name,"_permanova_by season.csv"))
...
write.csv(mod.effects_sig, paste0("Model-output/permanova/",name,"_", subset_name, "_permanova_by season_*.csv"))
...
write.csv(as.data.frame(summary(myrdaall)$biplot), paste0("Model-output/db-rda/",name,"_", subset_name,"_all_loadings.csv"))
# site coordinates
write.csv(as.data.frame(summary(myrdaall)$site), paste0("Model-output/db-rda/",name,"_", subset_name,"_all_axes.csv"))
# variation explained by first two axes
write.csv(summary(myrdaall)$cont$importance, paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained.csv"))
...
write.csv(round(cbind(ef$vectors$arrows, ef$vectors$r),2), paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-by-predictors.csv"))
...
df3 <- df2
var1 <- round(read.csv(paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained.csv"), row.names = 1)[2,1]*100, 2)
var2 <- round(read.csv(paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained.csv"), row.names = 1)[2,2]*100, 2)

pdf(paste0("Figures/microbial-diversity/rda/",name,"_", subset_name,"_dbrda-all1.pdf"),  height=5.5, width=7)
ggplot(rdadat, aes(CAP1, CAP2)) +
  ...
  labs(x=paste0("RDA1 (", var1, "%)"), y=paste0("RDA2 (", var2, "%)"), title=subset_name) + # amend according to variance explained
...
# with soil property eigenvectors
pdf(paste0("Figures/microbial-diversity/rda/",name,"_", subset_name,"_dbrda-all3.pdf"), height=5.5, width=7)
ggplot(rdadat, aes(CAP1, CAP2)) +
...
# export mod effects
write.csv(t(mod.effects), paste0("Model-output/db-rda/",name,"_", subset_name,"_dbrda_all timepoints.csv"))
...
# import data for diversity
divdat0 <- read.csv(paste0("Processed-data/sequences/", region,"_", subset_name,"-diversity.csv"))
divdat$Season.Year <- as.factor(divdat$Season.Year)
divdat$Season <- as.factor(divdat$Season )
divdat$Season <- factor(divdat$Season, levels(divdat$Season)[c(2,3, 1)])
divdat$Cover <- as.factor(divdat$Cover)
...
divdat <- divdat[which(divdat$new.name %in% rownames(divmat_pa)),]
# import data for diversity
divmat_pa0 <- read.csv(paste0("Raw-data/sequence/",sampdate,"/divmat_pa_", region,"_", subset_name, ".csv"), row.names = 1)
# soil data
soildat$Sample <- paste0(soildat$Plot, "_", soildat$Season, "_", soildat$Year)
...
for(i in 1:length(seasons)) {  
  ...
  ## rda all
  # factors associated with each axis
  write.csv(as.data.frame(summary(myrdaall)$biplot), paste0("Model-output/db-rda/",name,"_", subset_name,"_all_loadings_", time, ".csv"))
  # site coordinates
  write.csv(as.data.frame(summary(myrdaall)$site), paste0("Model-output/db-rda/",name,"_", subset_name,"_all_axes_", time, ".csv"))
  # variation explained by first two axes
  write.csv(summary(myrdaall)$cont$importance, paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained_", time, ".csv"))
  # variation explained by each soil property
  ...
  write.csv(ef_df, paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-by-predictors_", time, ".csv"))
  ...
  df2  <- data.frame(summary(myrdaall)$biplot) # loadings: only keep top rated for first two axes
  df3 <- df2
  var1 <- round(read.csv(paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained_", time, ".csv"), row.names = 1)[2,1]*100, 2)
  var2 <- round(read.csv(paste0("Model-output/db-rda/",name,"_", subset_name,"_all_variance-explained_", time, ".csv"), row.names = 1)[2,2]*100, 2)
  
  pdf(paste0("Figures/microbial-diversity/rda/",name,"_", subset_name,"_dbrda-all1_", time, ".pdf"),  height=3.5, width=6)
  ggplot(rdadat, aes(CAP1, CAP2)) +
...
# export results
write.csv(t(mod.effects), paste0("Model-output/db-rda/*",name,"_", subset_name,"_dbrda_by timepoint.csv"))
write.csv(vifs3, paste0("Model-output/db-rda/*",name,"_", subset_name,"_dbrda_by timepoint_vifs.csv"))
write.csv(resp, paste0("Model-output/db-rda/*",name,"_", subset_name,"_dbrda_by timepoint_total-r2-sig.csv"))
